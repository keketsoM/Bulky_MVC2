...
namespace BulkyWeb.Areas.Customer.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            {
                cartList.Product.ProductImages = productImages.Where(u => u.ProductId == cartList.Product.Id).ToList();
        ...
        {
            var shoppingCart = _unitOfWork.ShoppingCartRepo.Get(u => u.Id == cartId, Track: true);
            ...
            else
            {
                ...
                _unitOfWork.ShoppingCartRepo.GetAll(u => u.ApplicationUserId == shoppingCart.ApplicationUserId).Count() - 1);
